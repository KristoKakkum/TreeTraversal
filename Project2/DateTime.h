...
GetDate3 calculates from RawTime the values of Day and Year and stores them in Date3.
Also, GetDate3 calculates from RawTime the month, stores the month name in buffer pMonthBuf
and at last stores the pointer pMonthBuf in Date3.
Return value 0 - nMonthBuf is too small or pMonthBuf or pDate3 is not correct, no result
1 - done
*/
